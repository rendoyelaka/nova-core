...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        // Companion fires ACTION_DELETE directly via AccessibilityService
        // without setting isUninstalling first — detect packageinstaller
        // in foreground to prevent redirect killing the uninstall dialog
